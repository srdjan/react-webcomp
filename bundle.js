...
var registerReact = require("./reactive-elements");

var Webcomp = React.createClass({
  displayName: "Webcomp",
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        "ul",
        null,
        this.props.config.items.map(function (i) {
          return React.createElement(
            "li",
            { key: i.name },
            i.name
...
},{"./reactive-elements":3,"react":149}],3:[function(require,module,exports){
(function (global){
"use strict";
...
function registerReact(elementName, reactClass) {
  ...
  elementPrototype.createdCallback = function () {
    ...
    getterSetter(this, "props", function () {
      return _this.reactiveElement.props;
    }, function (value) {
      return _this.reactiveElement.setProps(value);
    });
  };
